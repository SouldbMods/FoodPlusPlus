...
public class BlueberryPlantBlock extends FoodplusplusModElements.ModElement {
	@ObjectHolder("foodplusplus:blueberry_plant")
	public static final Block block = null;
	public BlueberryPlantBlock(FoodplusplusModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blueberry_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("foodplusplus:blueberry_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlueberriesItem.block, (int) (3)));
		}
